...
public class HtmlElement {
    ...
    {      
           ...
           TestLogging.logWebStep("Scrolling to element.", false);
...
//HTML Video Player
    ...
    // To play video in HTML 5 player
    public void HtmlvideoPlayerPlay() {

    	findElement();

    	final JavascriptExecutor js = (JavascriptExecutor) driver;

    	js.executeScript("return arguments[0].play()", element);
    }

    // To pause video in HTML 5 player
    public void HtmlvideoPlayerPause() {

    	findElement();

    	final JavascriptExecutor js = (JavascriptExecutor) driver;

    	js.executeScript("return arguments[0].pause()", element);
    }

    // Re-loads the video element
    public void HtmlvideoPlayerLoad() {

    	findElement();

    	final JavascriptExecutor js = (JavascriptExecutor) driver;

    	js.executeScript("return arguments[0].load()", element);
    }

    // Checks if the browser can play the specified audio/video type
    public void HtmlvideoPlayercanPlayType() {

    	findElement();

    	final JavascriptExecutor js = (JavascriptExecutor) driver;

    	String d[] = { "video/ogg", "video/mp4", "video/webm" };
    	for (int i = 0; i < d.length; i++) {
    		js.executeScript("return arguments[0].canPlayType(\"" + d[i] + "\")", element);
    	}
    ...
    public void HtmlvideoPlayerAutoplay() {

    	findElement();

    	final JavascriptExecutor js = (JavascriptExecutor) driver;

    	js.executeScript("return arguments[0].autoplay", element);
    }
    
    //Returns a TimeRanges object representing the buffered parts of the audio/video
    public void HtmlvideoPlayerBuffered() {

    	findElement();

    	final JavascriptExecutor js = (JavascriptExecutor) driver;
    	
    	 Long a = (Long) js.executeScript("return arguments[0].buffered.length", element);
		 for(int i=0;i<a;i++) {	
		 System.out.println("buffered Start "+i+" = "+js.executeScript("return arguments[0].buffered.start("+(a-1)+")", element));
		 System.out.println("buffered End "+i+"= "+js.executeScript("return arguments[0].buffered.end("+(a-1)+")", element));
		 }
    ...
    public void HtmlvideoPlayerControls() {

    	findElement();

    	final JavascriptExecutor js = (JavascriptExecutor) driver;

    	js.executeScript("return arguments[0].controls", element);
    }
    
    // increase volume
    public void HtmlvideoPlayerIncreaseVolume(int value) {

    	findElement();

    	final JavascriptExecutor js = (JavascriptExecutor) driver;

    	js.executeScript("return arguments[0].volume+="+value, element);
    } 
    
    // increase volume
    public void HtmlvideoPlayerDecreaseVolume(int value) {
    ...
    // Drag currentime
    public void HtmlvideoPlayerDragTimeForward(int value) {

    	findElement();

    	final JavascriptExecutor js = (JavascriptExecutor) driver;

    	js.executeScript("return arguments[0].currentTime+="+value, element);
    } 
    
    // Drag currentime
    public void HtmlvideoPlayerDragTimeBackward(int value) {
